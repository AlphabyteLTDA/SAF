    ...
    <main className="min-h-screen pb-20 pt-6 px-4 bg-saf-50/50 flex flex-col items-center">
      <div className="w-full max-w-md mx-auto flex flex-col gap-6">
        <div className="flex flex-col gap-2 px-1 text-center">
          <h1 className="text-2xl font-bold text-saf-900 leading-tight">
            Catálogo SAF <br />
            <span className="text-saf-600">Biblioteca Missionária</span>
          </h1>
          <p className="text-saf-500 text-sm italic">Descubra e solicite livros para sua edificação.</p>
        </div>
